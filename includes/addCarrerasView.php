          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- form start   -->
                ...
                <form action="includes/models/studentsModel3.php" id="guardar-registro" method="POST" autocomplete="off" enctype="multipart/form-data">
                   <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputName">Nombre</label>
                    <input type="text" class="form-control" id="exampleInputName" placeholder="Nombre de la Carrera" name="nameaddc">
                  </div>
